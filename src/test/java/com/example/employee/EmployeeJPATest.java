...
public class EmployeeJPATest {
    ...
    public void setUp() throws Exception {
        ...
        flyway.setDataSource("jdbc:mysql://localhost:3306/employee_db?autoReconnect=true&useUnicode=true&characterEncoding=utf8&useSSL=true",
                "root","root");
        flyway.clean();
        flyway.migrate();
    }
    ...
    public void should_return_employee_when_input_employee_name() throws Exception {
        ...
        String actualName = employeeRepository.findOneByEmployeeName("xiaohong").getName();
    ...
    public void should_return_employee_given_character_in_name_and_salary_large_than() throws Exception {
        ...
        Employee expectedEmployee = new Employee(1,"xiaohong",19,"female",1,7000);
        String actualName = employeeRepository.findOneByWhoNameIncludeAndSalaryGreatThan("n", 6000).getName();
        assertThat(actualName).isEqualTo(expectedEmployee.getName());
    }
